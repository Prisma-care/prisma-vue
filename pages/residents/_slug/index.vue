    ...
    <section v-else>
      ...
      <div v-else>
        ...
        <b-modal ref="editModalRef" id="editStoryModal" hide-footer title="Bewerk tekst">
          <b-form-textarea id="formEdit" v-model="editStory" placeholder="Vertel het verhaal" :rows="3" :max-rows="6">
          </b-form-textarea>
          <hr>
          <div class="row">
            <div class="col-12">
        ...
        <div class="story-container">
          ...
          <b-btn v-if="this.albums.length > 0" variant="primary" size="sm" id="addStoryBtn" class="btn btn-primary btn-sm d-flex justify-content-center align-items-center mb-1 d-print-none"
            @click="showAddModal">
            <i class="material-icons">add</i>Verhaal toevoegen
          </b-btn>

          <div v-for="(album, index) in albums" v-bind:key="album.id + 'stories'">
            <div class="story-category" :id="album.title">
              ...
              <div class="row">
                <div v-for="story in album.stories" class="story col-md-6 col-lg-4 d-print-none" v-bind:key="story.id" v-bind:class="{checked: checkedStories.includes(story.id),
                  ...
                  <div v-if="story['type'] == 'image' || story['type'] == 'youtube'">
                    ...
                    <b-card title="Card Title" :img-src="story.type === 'youtube' ? getYouTubeThumb(story.source) : 'undefined'" img-alt="Image"
                      ...
                      <b-btn variant="primary" @click="index = story['index']" v-if="story['type'] == 'youtube'" class="btn-play d-flex justify-content-center align-items-center">
                        <i class="material-icons md-32 mx-auto">play_arrow</i>
                      </b-btn>

                      <b-btn variant="primary" @click="index = story['index']" v-if="story['type'] == 'image'" class="btn-zoom d-flex justify-content-center align-items-center">
			   ...
			   story['type'] == 'youtube'" class="mt-3">{{ story['description'] }}</p>
                  ...
                  <b-btn v-if="story['description'] && !story['source']" variant="outline-light" size="sm" class=" d-flex justify-content-center align-items-center mb-2"
                    @click="showEditModal">
          ...
          <div class="container d-flex text-muted">
            ...
            <a href="javascript:window.print()" class="btn btn-sm btn-primary d-flex align-items-center" :disabled="checkedStories.length > 0">
