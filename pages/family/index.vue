  ...
  <div>
    ...
    <p class="lead">Waar babbelt Lea graag over? Verzamel samen beelden die personeel in het woonzorgcentrum helpen om een gesprek aan te knopen.</p>
      ...
      <div class="col-md-4 text-right pt-5">
        <router-link to="family/invite" class="btn btn-primary">Vraag hulp aan een familielid</router-link>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-4">
        <img src="../../assets/img/invite-ownphotos.jpg" alt="Foto's uit jullie familie albums" class="img-fluid mb-4">
      </div>
      <div class="col-8 pt-5">
        ...
        <router-link to="family/invite" class="btn btn-light">Vraag hulp</router-link>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-4">
        <img src="../../assets/img/invite-generalstories.jpg" alt="Beelden over de interesses van Lea" class="img-fluid">
      </div>
    </div>
